...
| [4.2](phase-4/4.2-shap-what-it-does-and-doesnt-prove.md) | SHAP: what it does and doesn't prove | `bastion.policy.reason_codes`, `ModelBundle.contributions_from_matrix` | written |
